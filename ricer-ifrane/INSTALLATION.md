...
1. Extract the `ricer-ifrane.zip` file to a location on your computer
2. Recommended: `C:\Projects\ricer-ifrane` (Windows) or `~/Projects/ricer-ifrane` (Mac/Linux)
...
**macOS/Linux:**
1. Open Terminal
2. Navigate to project: `cd ~/Projects/ricer-ifrane`
...
3. You should see the login page with 🔥 icon
